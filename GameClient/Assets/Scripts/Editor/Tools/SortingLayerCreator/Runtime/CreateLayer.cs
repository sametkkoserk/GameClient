...
namespace Editor.Tools.SortingLayerCreator.Runtime
{
  ...
  public class CreateLayer : EditorWindow
  {
    ...
    /// <summary>
    ///   It creates new sorting layers. Do not use directly! If you want to create sorting layer, you need to add new key
    ///   to LayerKey.cs script in ScreenManager. uses <see cref="LayerKey" />.
    /// </summary>
