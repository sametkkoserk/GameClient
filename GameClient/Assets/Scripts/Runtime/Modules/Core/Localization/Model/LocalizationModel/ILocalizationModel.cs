...
namespace Runtime.Modules.Core.Localization.Model.LocalizationModel
{
  public interface ILocalizationModel
  {
    ...
    /// <summary>
    ///   If word with arguments use this method. Do not forget to remove <see cref="LocalizationTextBehaviour" /> and add
    ...
    /// <summary>
    ///   If word with arguments use this method. Do not forget to remove <see cref="LocalizeStringEvent" /> and add
    ///   <see cref="LocalizationTextBehaviour" />.
    /// </summary>
    /// <param name="tmp">TextMeshProGui object.</param>
    /// <param name="tableKey">Table of Key. Window -> Panels -> Localization Tables. Find key and it's table.</param>
    /// <param name="translateKey">Each translate has different key.</param>
    /// <param name="arguments">
    ///   Changeable arguments. limitless strings arguments can be acceptable. However needs add to
    ///   <see cref="LocalizationTextBehaviour" />.
    /// </param>
